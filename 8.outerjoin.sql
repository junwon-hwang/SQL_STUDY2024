...
-- 회원정보(user)과 회원의 주문내역(order)을 조회
-- # OUTER JOIN
...
--INNER JOIN : 41건
--LEFT JOIN : INNER 41건 + 부서가없는 사원 5건 = 46건 
--RIGHT JOIN : INNER 41건 + 사원이 없는 부서 2건 = 43건
--FULL JOIN :   INNER 41건 + 부서가없는 사원 5건 + 사원이 없는 부서 2건= 48건
